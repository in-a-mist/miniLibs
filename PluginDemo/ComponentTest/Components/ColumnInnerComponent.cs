...
{
    public class ColumnInnerComponent : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the ColumnInner class.
        /// </summary>
        public ColumnInnerComponent()
          : base("ColumnInner", "C",
              "金柱",
              "Test", "Columns")
        {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            //
            ColumnInner column = new ColumnInner(diameter, height);
        ...
        {
            get { return new Guid("bf7243a6-8739-4e1e-94fa-0dc760c1846e"); }
        }
    }
}