...
{
    public class ColumnCornerOtComponent : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the ColumnCornerOtComponent class.
        /// </summary>
        public ColumnCornerOtComponent()
          : base("ColumnCornerOt", "C",
              "角檐柱",
              "Test", "Columns")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            //
            ColumnCornerOt column = new ColumnCornerOt(diameter, height);
        ...
        {
            get { return new Guid("7dedba83-be5a-4681-ad5c-f6a5ddd95dd6"); }
        }
    }
}