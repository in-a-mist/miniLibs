...
{
    public class FangLockOnHeadComponent : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the FangLockOnHeadComponent class.
        /// </summary>
        public FangLockOnHeadComponent()
          : base("FangLockOn", "F",
              "箍头枋",
              "Test", "Fangs")
        {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            //
            FangLockOnHead fang = new FangLockOnHead(length);
            fang.Position = position;

            //
            Brep result = fang.Create();
        ...
        {
            get { return new Guid("d8590bed-eac0-43a6-b392-1626fa79284f"); }
        }
    }
}